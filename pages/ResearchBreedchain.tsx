...
import { Cat, Database, Shield, GitBranch, FileText, Smartphone, Globe, Server, Cpu, TrendingUp, CheckCircle, AlertTriangle, Clock, Users, ImageIcon, X } from 'lucide-react';
        ...
        <div className="space-y-8 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                    ...
                    <div
                        className="bg-white rounded-2xl overflow-hidden shadow-lg border border-slate-100 flex flex-col items-center justify-center cursor-zoom-in group relative"
                    ...
                    >
                        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors z-10 flex items-center justify-center opacity-0 group-hover:opacity-100">
                            <div className="bg-white/90 p-2 rounded-full shadow-lg text-slate-600">
                                <TrendingUp size={20} />
                            </div>
                        </div>
                        <img
                            src="https://storage.googleapis.com/distilledchild/research/breedchain/infographic_for_breedchain.png"
            ...
            {isZoomed && (
                ...
                >
                    ...
                    >
                        <img
                            src="https://storage.googleapis.com/distilledchild/research/breedchain/infographic_for_breedchain.png"
                            alt="Breedchain System Architecture Diagram Full Size"
